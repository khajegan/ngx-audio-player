...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(NgxAudioPlayerModule, { declarations: [SecondsToMinutesPipe, AudioPlayerComponent], imports: [CommonModule, FormsModule, MatLegacyButtonModule, MatLegacyCardModule, MatLegacyTableModule, MatLegacyFormFieldModule,
